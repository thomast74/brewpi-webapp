...
class BrewPi(models.Model):
    ...
    @classmethod
    def create(cls, device_id, firmware_version, ip_address, web_address, web_port, brewpi_time):
        brewpi = cls(device_id, device_id, firmware_version, ip_address, web_address, web_port, brewpi_time)
    ...
    def __str__(self):
        return "BrewPi: [{}] {} -> '{}']".format(self.name, self.device_id,
